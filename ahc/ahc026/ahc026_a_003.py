...
class WareHouse:
    ...
    def solve(self):
        while True:
            ...
            # if min_upper_idx != -1 and min_upper_idx != len(self.b[frm]) - 1 and min_upper < to_max_v:
                # v = self.b[frm][min_upper_idx + 1]
            for jj in min_upper_list:
                # print(jj, *b[frm], file=sys.stderr)
                v = self.b[frm][jj + 1]
                self.move(v, to)
